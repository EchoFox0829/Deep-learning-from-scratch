...
def most_similar(query, word_to_id, id_to_word, word_matrix, top=5):
    ...
    :param word_matrix: Matrix containing word vectors. Each row is expected to contain the vector for the corresponding word
    :param top: Number of top results to display
    '''
...
def convert_one_hot(corpus, vocab_size):
    ...
    :param corpus: List of word IDs (1D or 2D NumPy array)
    :param vocab_size: Vocabulary size
    :return: One-hot representation (2D or 3D NumPy array)
    '''
    N = corpus.shape[0]
...
def ppmi(C, verbose=False, eps = 1e-8):
    '''Create PPMI (Positive Pointwise Mutual Information)
